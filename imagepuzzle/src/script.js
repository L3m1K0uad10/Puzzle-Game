...
function backgroundColorCheck(id, row, col) {
    ...
    let backgroundColor = window.getComputedStyle(element).backgroundImage;
...
function move(cellNo, cellCoord) {
    ...
    if (cellNo == "E1") {
        ...
        if (isSubvalue) {
            let emptyGridBG = window.getComputedStyle(emptyGridElement).backgroundImage;
            let cellGridBG = window.getComputedStyle(cellElement).backgroundImage;
            document.getElementById(emptyGridCellNo).style.backgroundImage = cellGridBG;
            document.getElementById("E1").style.backgroundImage = emptyGridBG;
            findEmptyGrid();
            findAvailablePuzzlePieces();
        } 
    }
    if (cellNo == "E2") {
        ...
        if (isSubvalue) {
            ...
            let cellGridBG = window.getComputedStyle(cellElement).backgroundImage;
            document.getElementById(emptyGridCellNo).style.backgroundImage = cellGridBG;
            document.getElementById("E2").style.backgroundImage = emptyGridBG;
            findEmptyGrid();
            findAvailablePuzzlePieces();
        } 
    }
    if (cellNo == "E3") {
        ...
        if (isSubvalue) {
            ...
            let cellGridBG = window.getComputedStyle(cellElement).backgroundImage;
            document.getElementById(emptyGridCellNo).style.backgroundImage = cellGridBG;
            document.getElementById("E3").style.backgroundImage = emptyGridBG;
            findEmptyGrid();
            findAvailablePuzzlePieces();
        } 
    }
    if (cellNo == "E4") {
        ...
        if (isSubvalue) {
            ...
            let cellGridBG = window.getComputedStyle(cellElement).backgroundImage;
            document.getElementById(emptyGridCellNo).style.backgroundImage = cellGridBG;
            document.getElementById("E4").style.backgroundImage = emptyGridBG;
            findEmptyGrid();
            findAvailablePuzzlePieces();
        } 
    }
    if (cellNo == "E5") {
        ...
        if (isSubvalue) {
            ...
            let cellGridBG = window.getComputedStyle(cellElement).backgroundImage;
            document.getElementById(emptyGridCellNo).style.backgroundImage = cellGridBG;
            document.getElementById("E5").style.backgroundImage = emptyGridBG;
            findEmptyGrid();
            findAvailablePuzzlePieces();
        } 
    }
    if (cellNo == "E6") {
        ...
        if (isSubvalue) {
            ...
            let cellGridBG = window.getComputedStyle(cellElement).backgroundImage;
            document.getElementById(emptyGridCellNo).style.backgroundImage = cellGridBG;
            document.getElementById("E6").style.backgroundImage = emptyGridBG;
            findEmptyGrid();
            findAvailablePuzzlePieces();
        } 
    }
    if (cellNo == "E7") {
        ...
        if (isSubvalue) {
            ...
            let cellGridBG = window.getComputedStyle(cellElement).backgroundImage;
            document.getElementById(emptyGridCellNo).style.backgroundImage = cellGridBG;
            document.getElementById("E7").style.backgroundImage = emptyGridBG;
            findEmptyGrid();
            findAvailablePuzzlePieces();
        } 
    }
    if (cellNo === "E8") {
        ...
        if (isSubvalue) {
            ...
            let cellGridBG = window.getComputedStyle(cellElement).backgroundImage;
            document.getElementById(emptyGridCellNo).style.backgroundImage = cellGridBG;
            document.getElementById("E8").style.backgroundImage = emptyGridBG;
            findEmptyGrid();
            findAvailablePuzzlePieces();
        } 
    }
    if (cellNo == "E9") {
        ...
        if (isSubvalue) {
            ...
            let cellGridBG = window.getComputedStyle(cellElement).backgroundImage;
            document.getElementById(emptyGridCellNo).style.backgroundImage = cellGridBG;
            document.getElementById("E9").style.backgroundImage = emptyGridBG;
            findEmptyGrid();
            findAvailablePuzzlePieces();
        } 
    }
